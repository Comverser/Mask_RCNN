...
def compute_ap(gt_boxes, gt_class_ids, gt_masks,
    ...
    gt_match, pred_match, overlaps, comp = compute_matches(
...
def compute_matches_seg(gt_boxes, gt_class_ids, gt_masks,
                    pred_boxes, pred_class_ids, pred_scores, pred_masks,
                    iou_threshold=0.1, score_threshold=0.0):
    """Finds matches between prediction and ground truth instances.
...
def compute_ap_seg(gt_boxes, gt_class_ids, gt_masks,
               pred_boxes, pred_class_ids, pred_scores, pred_masks,
               iou_threshold=0.1):
    """Compute Average Precision at a set IoU threshold (default 0.5).
    ...
    """
    # Get matches and overlaps
    gt_match, pred_match, overlaps,comp = compute_matches_seg(
        gt_boxes, gt_class_ids, gt_masks,
        pred_boxes, pred_class_ids, pred_scores, pred_masks,
        iou_threshold)
